...
const plugin = {
    ...
    activate: function(app, mainMenu, palette, restorer) {
        ...
        const group = [
            { command: 'help:open', args: {text: 'plotly.py Reference', url: 'https://plot.ly/python/'}},
            { command: 'help:open', args: {text: 'plotly.py Property Reference', url: 'https://plot.ly/python/reference/'}}
        ];
